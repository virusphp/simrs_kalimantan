...
-->
							<section v-if="summaryPage">
								...
								<div class="row">    
									...
									<div class="col-5">No. RM</div><div class="col-7">{{ no_rekam_medik }}</div>
									<div class="col-5">Nama</div><div class="col-7">{{ nama }}</div>
									<div class="col-5">Tanggal Lahir</div><div class="col-7">{{ data_pasien.tanggal_lahir }}</div>
									<div class="col-5">Jenis Kelamin</div><div class="col-7">{{ data_pasien.jeniskelamin }}</div>
									<div class="col-5">Alamat</div><div class="col-7">{{ data_pasien.alamat_pasien }}</div>
									<div class="col-5">Propinsi</div><div class="col-7">{{ data_pasien.provinsi.propinsi_nama }}</div>
									<div class="col-5">Kabupaten</div><div class="col-7">{{ data_pasien.kabupaten.kabupaten_nama }}</div>
									<div class="col-5">Kecamatan</div><div class="col-7">{{ data_pasien.kecamatan.kecamatan_nama }}</div>
									<div class="col-5">Kelurahan</div><div class="col-7">{{ data_pasien.kelurahan.kelurahan_nama }}</div>
								</div>
								<div class="row">
									<div class="col-6">
										<base-button type="danger" class="my-4" @click.prevent="prevPage(0)">&lt; Kembali</base-button>
